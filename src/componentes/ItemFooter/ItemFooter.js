    ...
    <div className='container-fluid footerContainer'>
     ...
     <hr></hr>
        <div className="col-xs-12 col-md-6 col-lg-4">
          <p className='h3 fw-bolder'>Contacto</p>
          <p className='h5 m-3'>115478-2712</p>
          <p className='h5 m-3'>tocappelli@gmail.com</p>
          <a rel="noreferrer" href="https://www.linkedin.com/in/tocappelli/"  target="_blank" className='refStyles '>Linkedin</a>
        </div>
        <div className="col-xs-12 col-md-6 col-lg-4">
          <p className='h3 fw-bolder'>CURSOS REALIZADOS EN CODER HOUSE</p>
          <p className='h5 m-3'>Desarrollo Web</p>
          <p className='h5 m-3'>JavaScript</p>
          <p className='h5'>React Js</p>
        </div>
        <div className="col-xs-12 col-md-6 col-lg-4 row">
        <p className='h3 fw-bolder'>Github</p>
        ...
        <div className="col-xs-12 col-md-6 col-lg-12 mt-5">
            <p className='h5'>© 2022 Tomas Cappelli</p>
            <hr></hr>
          </div>
      </div>
