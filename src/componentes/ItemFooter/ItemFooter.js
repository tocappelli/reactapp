...
const ItemFooter = ()=> {
  return (
    <div className='container-fluid footerContainer'>
     ...
     <hr></hr>
        <div className="col-xs-12 col-md-12 mt-3 col-lg-4">
        ...
        <div className="col-xs-12 col-md-12 mt-3 col-lg-4 row">
        <p className='h5 '>Github</p>
           ...
           <a rel="noreferrer" href="https://reactapp-ecommerce.vercel.app/ "  target="_blank" className='refStyles '>Proyecto React Js</a>
          </div>
        <div className="col-xs-12 col-md-12 mt-3 col-lg-12 ">
